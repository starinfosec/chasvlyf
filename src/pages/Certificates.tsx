...
export function Certificates() {
  ...
  const certs = [
    {
      title: t("Udyam Certificate", "उद्यम प्रमाण पत्र"),
      icon: "business",
      description: t("Official registration under the Ministry of Micro, Small and Medium Enterprises.", "सूक्ष्म, लघु और मध्यम उद्यम मंत्रालय के तहत आधिकारिक पंजीकरण।"),
      color: "text-primary",
      bg: "bg-primary/10",
      image: "/udyam.png"
    },
    {
      title: t("GST Certificate", "जीएसटी प्रमाण पत्र"),
      icon: "receipt_long",
      description: t("Registered under the Goods and Services Tax Act for transparent business operations.", "पारदर्शी व्यापार संचालन के लिए वस्तु एवं सेवा कर अधिनियम के तहत पंजीकृत।"),
      color: "text-secondary-fixed",
      bg: "bg-secondary-fixed/10",
      image: "/gst.png"
    },
    {
      title: t("FSSAI License", "FSSAI लाइसेंस"),
      icon: "restaurant",
      description: t("Certified by the Food Safety and Standards Authority of India for premium food quality.", "प्रीमियम खाद्य गुणवत्ता के लिए भारतीय खाद्य सुरक्षा और मानक प्राधिकरण द्वारा प्रमाणित।"),
      color: "text-tertiary",
      bg: "bg-tertiary/10",
      image: "/fssai.jpg"
    },
    {
      title: t("Certificate of Incorporation", "निगमन का प्रमाण पत्र"),
      icon: "gavel",
      description: t("Legally incorporated entity ensuring standardized and compliant operations.", "मानकीकृत और अनुपालन संचालन सुनिश्चित करने वाली कानूनी रूप से निगमित इकाई।"),
      color: "text-primary",
      bg: "bg-primary/10",
      image: "/cc.jpg"
    }
          ...
          {certs.map((cert, idx) => (
            <div key={idx} className="bg-surface-container-lowest rounded-3xl shadow-sm border border-surface-variant hover:shadow-xl hover:border-primary/30 transition-all duration-300 group overflow-hidden flex flex-col">
              <div className="h-48 overflow-hidden relative">
                <img loading="lazy" decoding="async" src={cert.image} alt={cert.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
